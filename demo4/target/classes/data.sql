...
('SpaceX Starship', 'Designed by Elon Musk!', 900000000, 1),
('LauncherOne', 'The safest rocket ship known to man!', 450000000, 1),
('Vulcan Centaur', 'Made from rare materials!', 700000000, 1),
('MX-774', 'Vintage rocket ship designed to be cost efficient!', 1000000000, 1),
('PGM-11 Redstone', 'The most operator-friendly rocket ship!', 200000000, 1),
('New Shepherd', 'Our most unique lightweight design!', 300000000, 1);
...
INSERT INTO Customer (FIRST_Name, LAST_Name, email, PHONE_Number, username, password, is_Admin, address_Line, state, country, zip_Code) VALUES
